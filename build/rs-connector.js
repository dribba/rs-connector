(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("react"), require("reactive-store"));
	else if(typeof define === 'function' && define.amd)
		define(["react", "reactive-store"], factory);
	else {
		var a = typeof exports === 'object' ? factory(require("react"), require("reactive-store")) : factory(root["react"], root["reactive-store"]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ConnectKey = __webpack_require__(4);

	var _ConnectKey2 = _interopRequireDefault(_ConnectKey);
	...
	function resolveKeyString(key) {
	    ...
	    return [new _ConnectKey2.default(keyName, key)];
	}

	function resolveKeysArray(keys) {
	    var resolveArray = function resolveArray(_ref) {
	        var _ref2 = _slicedToArray(_ref, 2),
	            key = _ref2[0],
	            name = _ref2[1];

	        return new _ConnectKey2.default(key, name);
	    };

	    return keys.map(function (key) {
	        if (typeof key === 'string') return resolveKeyString(key)[0];
	        if (key instanceof Array) return resolveArray(key);else throw new Error('Key: ' + key + ' - Can\'t be resolved');
	    });
	}

	function resolveKeyObject(keys) {
	    return Object.keys(keys).map(function (key) {
	        return new _ConnectKey2.default(key, keys[key]);
	    });
	}
	...
	function resolveKeys(keys) {
	    ...
	    } else if (keys && (typeof keys === 'undefined' ? 'undefined' : _typeof(keys)) === 'object') {
	...
	function createChannel(rsKeys, store) {
	    ...
	    var connection = _Connection2.default.create(store, allKeys);
	    return ChannelApi(connection);
	}

	function Channel(rsKeys, store) {
	...
	function ChannelApi(connection) {
	    return {
	        ...
	        mapAll: function mapAll(fn) {
	            return this.map((0, _mappers.mapAll)(fn));
	        },
	        mapKey: function mapKey(key, fn) {
	            return this.map((0, _mappers.mapKey)(key, fn));
	        },
	        mapObj: function mapObj(obj) {
	            return this.map((0, _mappers.mapObj)(key, fn));
	        },
	        ...
	        filterKeys: function filterKeys(fn) {
	            return this.map((0, _mappers.filterKeys)(fn));
	        },
	        filterKey: function filterKey(key, fn) {
	            return this.map((0, _mappers.filterKey)(key, fn));
	        },
	        filterObj: function filterObj(obj) {
	            return this.map((0, _mappers.filterObj)(obj));
	        },
	        noDuplicates: function noDuplicates() {
	            return this.filter((0, _mappers.noDuplicates)());
	        },
	        concat: function concat(other, mergeFn) {
	            return ChannelApi(connection.concat(other._conn, mergeFn));
	        },
	        merge: function merge(other, mergeFn) {
	            return this.concat(other, mergeFn);
	        },
	        join: function join(other, mergeFn) {
	            return this.concat(other, mergeFn);
	        },
...
/***/ function(module, exports, __webpack_require__) {
	...
	function Connector(Component, connection) {
	    return function (_React$PureComponent) {
	        ...
	        function _class(props) {
	            ...
	            _this.hasRefs = (_this.refs || []).length;
	            _this.isCompositeComponent = typeof Component === 'function' && Component instanceof _react2.default.Component;
	        ...
	        _createClass(_class, [{
	            ...
	            value: function componentWillMount() {
	                ...
	                this.stop = this.connection.connect(function (state, firstRun) {
	                    if (firstRun) {
	                        _this2.state = state;
	                    } else {
...
/***/ function(module, exports) {
	...
	exports.default = ConnectKey;
	function ConnectKey(stateKey, storeKey) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	function Connection(pull, subscribe) {
	    return {
	        pull: pull,
	        subscribe: subscribe,
	        map: function map(fn) {
	        ...
	        connect: function connect(observer) {
	            return subscribe.subscribe(pull.pull)(observer);
	        }
	    };
	}
	Connection.create = function (store, keys) {
	    var pull = _Pull2.default.create(keys, store);
	    var subscribe = _Subscribe2.default.create(store);
...
/***/ function(module, exports) {
	...
	function Pull(pull) {
	    return {
	        pull: pull,
	        map: function map(fn) {
	            return Pull(function (cb) {
	                return pull(function (value) {
	                    return cb(fn(value));
	                });
	            });
	        },
	        ...
	        filter: function filter(fn) {
	            return Pull(function (cb) {
	                return pull(function (value) {
	                    return fn(value) && cb(value);
	                });
	            });
	        },
	        concat: function concat(other, mergeFn) {
	            return Pull(function (cb) {
	                pull(function (value1) {
	                    return other.pull(function (value2) {
...
/***/ function(module, exports) {
	        ...
	        concat: function concat(other) {
	            return Subscribe(function (pull) {
	                return function (observer) {
	                    ...
	                    var newObserver = function newObserver(value, firstRun) {
	...
	Subscribe.create = function create(store) {
	    return Subscribe(function (pull) {
	        return function (observer) {
	            return store.autorun(function (firstRun) {
	                pull(function (value) {
	                    return observer(value, firstRun);
	                });
	            }).stop;
	        };
	    });
...
/***/ function(module, exports, __webpack_require__) {
	...
	function mapKey(key, fn) {
	    return mapObj(_defineProperty({}, key, fn));
	};
	function mapObj(obj) {
	    return function (state) {
	        return Object.keys(state).reduce(function (acc, key) {
	...
	function filterKey(key, fn) {
	    return filterObj(_defineProperty({}, key, fn));
	};
	function filterKeys(fn) {
	    return function (state) {
	        return Object.keys(state).reduce(function (acc, key) {
	...
	function noDuplicates() {
	    var previous;
	    return function (state) {
	        var result = previous === undefined || !(0, _shallowequal2.default)(previous, state);
	        previous = state;
	        return result;
	    };
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var fetchKeys = __webpack_require__(10);
